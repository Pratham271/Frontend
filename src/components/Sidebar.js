...
const Sidebar = () => {
  ...
  return (
    <div className="flex">
      ...
      <div className="md:hidden cursor-pointer px-4 py-2 bg-gray-100 rounded-3xl mt-2 ml-1" onClick={toggleSidebar}>
        {isOpen ? <AiOutlineClose size={24} /> : <AiOutlineAlignLeft className='text-blue-950' size={24} />}
      </div>
      ...
      <div className="md:hidden flex items-start">
        ...
        <IoMdLaptop size={20} className={`text-blue-950 mt-[16px] ${isLessThan400?'ml-40':'ml-52'}`} />
      ...
      <div
        ...
        } md:relative md:flex md:flex-col md:justify-between md:h-screen md:w-1/4 z-10`}
      >
        <div className="flex items-center ">
        {/* Close Icon (visible on small screens) */}
        <div className="md:hidden absolute top-9 right-4 cursor-pointer " onClick={toggleSidebar}>
        ...
        <nav className="px-4 py-2">
          <ul className="space-y-2 py-4">
            ...
            <BsQuestion size={18} className="text-blue-950 absolute  text-center pl-[2px] pt-[3px]" />
              ...
              {/* <BsQuestion size={24} className="text-blue-950" /> */}
              <a className="block py-1" href="/">
                My Library
              </a>
            </li>
            ...
            {/* <div className="py-2 bg-red-300 mt-4"> */}
            </li>
            <li className='relative'>
