...
useEffect(() => {
  ...
  return (
   ...
   >
      ...
      <div   className="bg-white sm:w-[100px] lg:w-2/5  rounded-lg shadow-lg relative">
        <div className="flex items-center justify-between lg:mb-4 sm:mb-0 p-6">
        ...
        <form>
          <div className="mb-4 mx-4">
            ...
            <input
              ...
              name="assessmentName"
              value={"Type Here"}
              className="lg:w-[630px] sm:w-[150px] border rounded-lg py-2 px-3 text-blue-900 border-gray-300 focus:outline-none font-medium h-12 text-lg"
              disabled
          ...
          <div className="mb-4 mx-4">
            ...
            <select
              id="purpose"
              name="purpose"
              className="w-[630px] border rounded-lg py-2 px-3 text-blue-900 border-gray-300 focus:outline-none font-medium h-12 text-lg"
              disabled
            >
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-col h-[150px] w-[630px] border rounded-lg border-gray-300 ml-6">
              <div className="h-[100px] border-b border-gray-300 flex px-3 mt-2 flex-wrap">
          ...
          <div className="flex justify-center mb-4 mt-4">
            <button
              className="bg-blue-500 text-white font-bold py-2 px-4 rounded w-[630px]"
              type="button"
              disabled
            >
              Save
